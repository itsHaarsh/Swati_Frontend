...
export const ForgotPassword = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(`${import.meta.env.VITE_API_URL}/api/create-accounts/forgot-password`, {
        method: 'POST',
        headers: {
    ...
    <div className="min-h-screen bg-white flex items-center justify-center py-8 sm:py-12 md:py-16 px-4 sm:px-6 animate-fade-in">
      <div className="max-w-md w-full">
        ...
        <div className="border border-stone-200 p-6 sm:p-8 md:p-12">
          <h2 className="text-2xl sm:text-3xl text-center mb-2 tracking-tight">Forgot Password</h2>
